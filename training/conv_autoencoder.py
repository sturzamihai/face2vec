...
bottleneck = keras.layers.Conv2D(
    6, (3, 3), activation='relu', padding='same', name='bottleneck')(encoder)
...
model.fit_generator(train, steps_per_epoch=1, epochs=1,
                    callbacks=[ModelCheckpoint('./checkpoints/cv-model-{epoch:02d}.hdf5', verbose=1)], validation_data=valid, validation_steps=1)
